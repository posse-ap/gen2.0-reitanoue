...
<header id="header" class="header">
    <div class="content-wrapper">
        ...
        <div class="header-right">
            <a class="make-button header-right-create" href="https://kuizy.net/prepare">クイズ・診断を作る</a>
...
<div class="clerfix header-spacer"></div>
...
<section class="container content-wrapper">
    <h2 class="quiz-title box-container">ガチで東京の人しか解けない！ #東京の難読地名クイズ</h2>
    <div id="quiz-box"></div>
</section>
