...
document.getElementById("tweet").addEventListener("click", function () {
  document.getElementById("tweetCheckmark").classList.remove("modal-checkbox"); //チェックボックスを青くする
  // document.getElementById("tweetCheckmark").classList.add("checked"); //チェックボックスを青くする
});
