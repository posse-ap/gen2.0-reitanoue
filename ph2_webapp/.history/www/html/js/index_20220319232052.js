...
document.getElementById("tweet").addEventListener("click", function () {
  document.getElementById("tweetCheckmark").classList.toggle("modal-checkbox"); //チェックボックスを青くする
  document.getElementById("tweetCheckmark").classList.toggl("checked"); //チェックボックスを青くする
});
