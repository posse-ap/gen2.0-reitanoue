...
for (let i = 1; i < 4; i++) {
  let clicked_contentcheck = document.getElementById("content_" + i);
    document.getElementById("content_" + i).classList.toggle("checkbox-checked");
    document.getElementById("contentCheck_" + i).classList.toggle("checked");
};
