...
<body>
  ...
  <section id='modalArea' class='modalArea'>
    ...
    <div class='modalWrapper'>
      <div class='modalContents'>
          ...
          <div class='grid'>
            ...
            <div class='float'>
              <label for="nYobi" class="modal-checkbox" id="content_1">
                <input id="nYobi" type="checkbox" name="studyContent" value="N予備校" onclick->
                <i class='fa-solid fa-circle-check' style='color: #ccc; margin-right:5px' id="contentCheck_1"></i>
                N予備校
              </label>
              <label for="dotInstall" class="modal-checkbox" id="content_2">
                ...
                <i class='fa-solid fa-circle-check' style='color: #ccc; margin-right:5px' id="contentCheck_2"></i>
                ドットインストール
              </label>
              <label for="posseHw" class="modal-checkbox" id="content_3">
                <input id='posseHw' type="checkbox" name="studyContent" value="POSSE課題">
                <i class='fa-solid fa-circle-check' style='color: #ccc; margin-right:5px' id="contentCheck_3"></i>
                POSSE課題
              </label>
            </div>
          </div>
        ...
        <div class='modal-content-2'>
          ...
          <div class='grid'>
            ...
            <div class='flex'>
              <label for='tweet' id='tweetCheckmark' class="modal-checkbox">
                <input type='checkbox' name='share-box' value='true' id='tweet' class='stretched-link'>
                <i class='fa-solid fa-circle-check' style='color: #ccc;'></i>
                Twitterにシェアする
              </label>
            </div>
          </div>
      ...
      <button id='modal-inner-button' class='modal-inner-button' onclick="func1()" >記録・投稿</button>
