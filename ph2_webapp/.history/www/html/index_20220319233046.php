          ...
          <div class='grid'>
            ...
            <div class='float'>
              <label for="nYobi" class="modal-checkbox" id="content_1">
                ...
                <i class='fa-solid fa-circle-check check' margin-right:5px' id="contentCheck_1"></i>
                N予備校
              </label>
              <label for="dotInstall" class="modal-checkbox" id="content_2">
                ...
                <i class='fa-solid fa-circle-check check' style='color: #ccc; margin-right:5px' id="contentCheck_2"></i>
                ドットインストール
              </label>
              <label for="posseHw" class="modal-checkbox" id="content_3">
                <input id='posseHw' type="checkbox" name="studyContent" value="POSSE課題">
                <i class='fa-solid fa-circle-check check' style='color: #ccc; margin-right:5px' id="contentCheck_3"></i>
                POSSE課題
              </label>
            </div>
          </div>
          ...
          <div class='grid'>
            ...
            <div class='float'>
              <label for="html" class="modal-checkbox" id="lang_1">
                ...
                <i class='fa-solid fa-circle-check check' style='color: #ccc; margin-right:5px'></i>
                HTML
              </label>
